...
print("FLAG{%s}" % hmac.new(s, b"v1|sqli-waf-bypass-whitespace-tabs", hashlib.sha256).hexdigest())
PY
...
# Create + seed the directory (waits for MySQL; db is already healthy via depends_on).

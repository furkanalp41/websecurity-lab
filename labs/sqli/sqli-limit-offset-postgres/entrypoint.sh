...
print("FLAG{%s}" % hmac.new(s, b"v1|sqli-limit-offset-postgres", hashlib.sha256).hexdigest())
PY
...
# Create + seed the feed (waits for Postgres; db is already healthy via depends_on).

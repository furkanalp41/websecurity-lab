...
print("FLAG{%s}" % hmac.new(s, b"v1|sqli-error-based-extractvalue", hashlib.sha256).hexdigest())
PY
...
# Create + seed the helpdesk (waits for MySQL; db is already healthy via depends_on).

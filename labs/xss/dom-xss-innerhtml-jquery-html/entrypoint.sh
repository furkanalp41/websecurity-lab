...
flag = "FLAG{%s}" % hmac.new(s, b"v1|dom-xss-innerhtml-jquery-html", hashlib.sha256).hexdigest()
sess = hmac.new(s, b"admin-session|dom-xss-innerhtml-jquery-html", hashlib.sha256).hexdigest()[:32]
print("FLAG=%s" % flag)
